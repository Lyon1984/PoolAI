...
0008 当前是 M1-E5 本地候选；把它纳入嵌入资源、release manifest 或本地 Testcontainers 验证，都不表示已经在远程数据库执行、完成数据库签核或获准部署发布。上述动作仍须分别取得 `@Lyon1984` 的明确确认。
