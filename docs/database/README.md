...
0008 是 M1-E5 本地候选，已由 `@Lyon1984` 通过 [Issue #44 M1-E5 增量数据库签核](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5053782353) 批准；该评论精确绑定本地候选 commit `a9030e2a69f5cf109f392960be630c9579c8b9cd`、SQL SHA-256 `5313c44a184497426c200654d41d411e6cc33a724c329f087d4c5d415e4b94ce` 与 release manifest schema `8..8`。签核后 0008 的字节和 checksum 不可变，后续修正只能新增前向 migration；该签核不表示候选已推送或远端 CI 已运行，也不授权远程数据库执行、部署或发布，上述动作仍须分别取得明确确认。
