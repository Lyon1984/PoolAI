...
1. 预置三个运行时角色后，空库按 0001/0002/0003/0004/0005/0006/0007/0008/0009 执行；验证缺角色、runtime owner 可登录、重复 migration 与 checksum 漂移都被拒绝。签核不构成远程执行授权，任何远程 migration 仍需另行明确批准。
