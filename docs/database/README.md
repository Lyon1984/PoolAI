...
0014 的旧候选 `48ccfcec6f26d7ab82b8ea8e6ecea5be35e2bbb2` 及 SQL SHA-256 `931a35ed64ae6e711ddbc4cf9ca18503ac62f46da6688c6a0efcd91592eb3fea` 已由 `@Lyon1984` 的 [Issue #44 永久撤回评论](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5142542677) 明确作废，不得合并或执行。当前替代候选 SQL SHA-256 为 `abbf0ac2c5265f830b65fcc447f78b30940183ff0236fc65491f7e920fae9e89`，把 semantic epoch 的首个 quota 表锁提升为 `EXCLUSIVE MODE`，使旧 0013 writer 在迁移取得任何 Group/Period 行锁前排空，同时允许普通 `ACCESS SHARE` 读取；release manifest 保持 `14..14`、PostgreSQL required major `18`，0002、0013 与 OpenAPI 原字节保持不变。只有绑定替代候选精确 commit、SQL checksum、manifest、新 semantic epoch/permission audit 摘要及真实 PostgreSQL 18 并发升级验证的新 Issue #44 永久 APPROVED 评论才能完成数据库签核；候选、测试和后续签核均不授权远程 migration、数据修复、部署、M3 Exit、发布或生产验收。
