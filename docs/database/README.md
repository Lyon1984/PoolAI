...
0009 已由 `@Lyon1984` 的 [Issue #44 增量数据库签核](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5055211358) 独立批准；该评论精确绑定候选 commit `818a6eabf0a7c4e9b2e843b3440316a2dabc2d96`、SQL SHA-256 `d09cb5e7f1054e7dc1870253fd0da5bf4a1eca6b94328c41cdae544e98bb2270`、release manifest `9..9` 与对应 OpenAPI SHA-256 `1c9dee2fe48cd3e2f0fa5a00805e07e21d303b5a4fa070faeab66f3be6132141`。其字节和 checksum 自该评论起不可变；后续修正只能新增前向 migration。新增 PostgreSQL 18 Testcontainers 已成功编译，但本地因无可用 Docker daemon 未执行；真实空库 0001..0009、函数/constraint/ACL 与 Unicode 边界测试仍是后续 PR/CI 合并门。独立的 [ADR 0008/OpenAPI 批准](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5055204931) 不替代数据库签核；两条评论均不授权远程 migration、部署或发布。
