...
- M3-E5 的 [`ADR 0013`](architecture/adr/0013-freeze-quota-reconciliation-layers-checkpoint-alignment-alerting-and-recovery-boundary.md) 已依据绑定候选 `23eb5338bf3aeca8adf7d4645812ec8d3ea21577` 与 ADR SHA-256 `b22d0625d5410950e973cbc53db29e6c7b35e414d0668cc7577b634624067d6a` 的 [Issue #44 永久替代架构批准](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5162578270) 转为 **Accepted**，冻结精确 period lineage、closed-period checkpoint、API/Worker 所有权、全局有界交付续扫、checkpoint-covered Inbox receipt 与同 session fenced bounded-rebuild；[旧架构批准](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5160040824) 仍是永久历史，但只绑定候选 `e4fea33d517c436e5f26f75d79dd675fd8aa63af`。独立的 [OpenAPI compatibility-window 批准](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5160055395) 仍只绑定 base `0ee892bf26713326cea667b524f59005b03ea9fd`、target SHA-256 `9ab3765ac644a665373e34d716ffb53a9ac6fdc7abdd28408d9f398fb9a362bf` 与一条 malformed-period `400` 诊断；[数据库 no-migration 批准](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5160055552) 仍保持 PostgreSQL 18 manifest `17..17`，不创建 migration 0018 或新增权限。三项批准均不授权远程数据操作、自动 Group disable、部署、M3-E5 closeout、M3 Exit 或发布验收。
