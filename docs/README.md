...
- [`ADR 0010`](architecture/adr/0010-freeze-upstream-account-base-url-safety-contract.md) 与第四条 compatibility-window 记录当前为 **Proposed**/`proposed`：候选只绑定 base `a2127f2d4a2ed8b0ccdd2b7fd6c62c27fd05eab0`、target OpenAPI SHA-256 `6f3bde282140f66e7c73ef811b17e11c51bbacb58bce6516a3ca4f3f98e977bb` 和六条 Account Base URL 长度/语法诊断；在 Issue #44 永久批准证据回写前，兼容门必须以 `pending approval` 失败关闭。该候选不声称完成连接期 DNS/redirect/egress SSRF 防线，也不签署 forward migration 0011、远程 migration、部署或发布。
