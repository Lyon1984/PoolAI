...
- M3-E4 的单一路由增量已由 `@Lyon1984` 的 [Issue #44 OpenAPI 永久签核](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5152742020) 批准；该评论精确绑定候选 `8989c8e9f4335cf4b2c2bcfd74f2cb89ba48544b`、base `f1348f8a4a348bf7064bdf54528e198f7838ab27` 与 OpenAPI SHA-256 `3049895a154cebb6f16a9e80646a21c8a18fe76d77a5aecb4511012e555c6ce0`，只增加 Admin dead-Outbox replay route、两个 schema 和两个 fixture。既有 71 operations、150 schemas、67 error types 与 10 SSE event types 均保持兼容，因此不需要 ADR、兼容窗口或 reset。独立的 [migration 0015 数据库签核](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5152743763) 绑定同一候选、SQL SHA-256 `d14a9dcf2dea98867c8c973ce850a2e122e4679d990701e36d7affb2d0181516`、manifest `15..15` 与 PostgreSQL major `18`。两项签核均不授权远程 migration、数据修复、部署、M3-E4/M3 Exit 或发布验收。
