...
- M3-E5 的 [`ADR 0013`](architecture/adr/0013-freeze-quota-reconciliation-layers-checkpoint-alignment-alerting-and-recovery-boundary.md) 已依据绑定候选 `7ddb80fabbbab3bebb2e143e69154fdcc0ffa599`、tree `591e102dc5e24cc55d5440fd2265f60366476b1c` 与 pre-evidence-backwrite ADR SHA-256 `e7cc80eba402902255adfcf07c9edade63f676ae3864bddd92e7bcaafd899199` 的 [Issue #44 永久 final-candidate 架构重签](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5164928196) 保持 **Accepted**，冻结精确 period lineage、closed-period checkpoint、Group-bounded point read、API/Worker 所有权、单页 1000 identity 的冻结快照续扫、final identity 重验、checkpoint-covered Inbox receipt 与同 session fenced bounded-rebuild；[先前 point-read 候选批准](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5164002774)、[更早替代批准](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5162578270) 与[初始批准](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5160040824) 仍是永久历史，但仅绑定各自旧候选。独立的 [OpenAPI compatibility-window 批准](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5160055395) 仍只绑定 base `0ee892bf26713326cea667b524f59005b03ea9fd`、target SHA-256 `9ab3765ac644a665373e34d716ffb53a9ac6fdc7abdd28408d9f398fb9a362bf` 与一条 malformed-period `400` 诊断；[数据库 no-migration 批准](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5160055552) 仍保持 PostgreSQL 18 manifest `17..17`，不创建 migration 0018 或新增权限。三项批准均不授权远程数据操作、自动 Group disable、部署、M3-E5 closeout、M3 Exit 或发布验收。
