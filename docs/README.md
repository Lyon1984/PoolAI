...
- M3-E4 的早期候选曾由 `@Lyon1984` 分别作出 [OpenAPI 永久签核](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5152742020) 和 [migration 0015 数据库签核](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5152743763)，但它们只覆盖候选 `8989c8e9f4335cf4b2c2bcfd74f2cb89ba48544b`、OpenAPI SHA-256 `3049895a154cebb6f16a9e80646a21c8a18fe76d77a5aecb4511012e555c6ce0` 与 migration 0015 SHA-256 `d14a9dcf2dea98867c8c973ce850a2e122e4679d990701e36d7affb2d0181516`。当前候选已前向演进为 OpenAPI SHA-256 `e0a72d2827318ce6f53e520292f3aea5bbaa9b9979ae0bc5b27d7b74a5d640d4`、migration 0016 SHA-256 `a0c8a395f6d51aab108a3ad3e1912e4008f3bdabfe01e809701737ed24b569db` 与 migration 0017 SHA-256 `11b7131a580a62725cb2ddbe3d82d4c626c7b63506f3848005856dc9dda7e15a`；旧评论不能批准这些新字节，必须在 M3-E4 完成前由新的精确永久评论取代。相对 base `f1348f8a4a348bf7064bdf54528e198f7838ab27` 的兼容检查仍为 additive，因此不需要兼容窗口或 reset；任何签核均不授权远程 migration、数据修复、部署、M3-E4/M3 Exit 或发布验收。
...
- `group-quota-events-v1.json` 是 `poolai.quota.v1`/schema v1 的唯一机器 Published Language；它按 Proposed [`ADR 0012`](architecture/adr/0012-freeze-quota-event-replay-ordering-and-projection-boundary.md) 区分物理 Outbox `event_sequence` 与稳定 ledger `source_event_sequence`。ADR 未获永久批准前，该候选不能作为 M3-E4 sign-off；一旦 Accepted，改变 event type、必填字段、既有语义、Group 分区或游标含义必须发布新 major 或由新的 ADR 明确治理。
