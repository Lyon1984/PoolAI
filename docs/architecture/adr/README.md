...
- [`0013-freeze-quota-reconciliation-layers-checkpoint-alignment-alerting-and-recovery-boundary.md`](0013-freeze-quota-reconciliation-layers-checkpoint-alignment-alerting-and-recovery-boundary.md) — freeze the three-layer authoritative/projection/delivery reconciliation boundary, logical-checkpoint comparison, explicit recovery controls, and the exact malformed-period compatibility window through separate permanent [architecture](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5160040824), [OpenAPI](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5160055395), and [database/no-migration](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5160055552) approvals.
