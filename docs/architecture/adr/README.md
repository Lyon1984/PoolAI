...
- [`0012-freeze-quota-event-replay-ordering-and-projection-boundary.md`](0012-freeze-quota-event-replay-ordering-and-projection-boundary.md) — distinguish physical Outbox delivery sequence from stable GroupQuota source sequence, freeze Group-partition poison/replay ordering, and place strict validation plus the durable Usage transaction before the published confirmation. It is not effective until an exact candidate is approved through Issue #44.
