...
- [`0010-freeze-upstream-account-base-url-safety-contract.md`](0010-freeze-upstream-account-base-url-safety-contract.md) — align Account Base URL length, transport, authority, path, and credential-bearing URI rules across OpenAPI, Supply, and the forward database candidate through the exact six-diagnostic [Issue #44 approval](https://github.com/Lyon1984/PoolAI/issues/44#issuecomment-5121040005).
