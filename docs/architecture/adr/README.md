...
- [`0008-freeze-api-key-unicode-scalar-text-contract.md`](0008-freeze-api-key-unicode-scalar-text-contract.md) — candidate correction that aligns API Key name/reason Unicode scalar validation across OpenAPI, .NET, and forward migration 0009; its exact eleven-diagnostic compatibility window remains pending explicit Issue #44 approval.
