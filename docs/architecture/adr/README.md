...
- [`0010-freeze-upstream-account-base-url-safety-contract.md`](0010-freeze-upstream-account-base-url-safety-contract.md) — bind the exact six-diagnostic M2-E2 compatibility window that aligns Account Base URL length, transport, authority, path, and credential-bearing URI rules across OpenAPI, Supply, and the forward database candidate; approval is still pending.
