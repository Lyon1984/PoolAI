...
| PoolAI 当前仓库状态 | 工作区内已经存在且可验证的资产 | M0-E1–E4 已形成完成证据并关闭；仓库负责的 PR/发布门已通过本地及目标 CI 的质量、安全、浏览器、真实容器和 Compose 验证；38 个 Epic 的 GitHub Issues/owner 已回读，DEC-001..042、数据库、OpenAPI 与 M0 Exit 已由 Issue #44 的四条独立永久评论签收。M1 已获准开始，但尚无 M1 业务 Epic 被声明实现或验收 |
