...
public sealed class CrossContextSqlBoundaryTests
{
    ...
    private static readonly Dictionary<string, string> FunctionOwners = new(StringComparer.Ordinal)
    {
        ...
        ["poolai_secret_envelope_v1_is_structurally_valid"] = Supply,
        ...
        ["poolai_operations_replay_dead_outbox"] = Operations,
        ["poolai_operations_append_attempt_fact_audit_once"] = Operations,
    };
