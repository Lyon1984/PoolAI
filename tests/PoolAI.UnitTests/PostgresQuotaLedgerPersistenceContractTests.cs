...
public sealed class PostgresQuotaLedgerPersistenceContractTests
{
    ...
    public void SignedDatabaseErrorsMapToStableApplicationFailures()
    {
        ...
        [
            ...
            ("MarkDispatched", "reservation_not_pending", QuotaLedgerFailure.ReservationLeaseLost),
            ("MarkDispatched", "reservation_owner_mismatch", QuotaLedgerFailure.ReservationLeaseLost),
            ("Renew", "invalid_reservation_renewal", QuotaLedgerFailure.ValidationFailed),
            ("Reserve", "invalid_reservation_renewal", QuotaLedgerFailure.Internal),
            ("Renew", "reservation_not_pending", QuotaLedgerFailure.ReservationLeaseLost),
            ("Renew", "reservation_owner_mismatch", QuotaLedgerFailure.ReservationLeaseLost),
            ("Renew", "reservation_lease_expired", QuotaLedgerFailure.ReservationLeaseLost),
            ("Renew", "reservation_max_lifetime_reached", QuotaLedgerFailure.ReservationLeaseLost),
            ("Expire", "reservation_not_pending", QuotaLedgerFailure.ReservationExpiryRaceLost),
            ("Expire", "reservation_lease_not_expired", QuotaLedgerFailure.ReservationExpiryRaceLost),
            ("Renew", "reservation_lease_not_expired", QuotaLedgerFailure.Internal),
            ("Settle", "reservation_lease_expired", QuotaLedgerFailure.Internal),
            ("AdjustUsage", "usage_adjustment_requires_dispatch", QuotaLedgerFailure.UsageWithoutDispatch),
            ("Reserve", "usage_adjustment_requires_dispatch", QuotaLedgerFailure.Internal),
            ("AdjustUsage", "adjustment_event_without_adjustment_fact", QuotaLedgerFailure.TerminalFactInvariantBroken),
            ("AdjustUsage", "terminal_reservation_missing_attempt_fact", QuotaLedgerFailure.TerminalFactInvariantBroken),
            ("AdjustUsage", "terminal_reservation_has_unexpected_attempt_fact", QuotaLedgerFailure.TerminalFactInvariantBroken),
            ("Reserve", "adjustment_event_without_adjustment_fact", QuotaLedgerFailure.Internal),
